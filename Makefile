...
INCS = -Os $(ARCH) -I./SDL2_image-2.0.5_mod -I./jpeg-6b_mod -I./libpng-1.2.24_mod -I${SYSROOT}/usr/include -I${SYSROOT}/usr/include/SDL2 -ffunction-sections -fdata-sections -Wall
LIBS = -L${SYSROOT}/usr/lib $(ARCH) -lSDL2_ttf -lSDL2_mixer -lSDL2 -lmad -lfreetype -lbz2 -lz -lpthread -lm
#-ljpeg -lpng
#removed -lSDL2_image
EXT_FLAGS =
else
DEFS = -DLINUX -DUSE_SDL_RENDERER -DNDEBUG -DMIYOO
INCS = -I./SDL2_image-2.0.5_mod -I./jpeg-6b_mod -I./libpng-1.2.24_mod  `sdl2-config --cflags` 
LIBS = `sdl2-config --libs` -lSDL2_ttf -lSDL2_mixer   -lz -lbz2 -lm
#-ljpeg -lpng -lSDL2_image 
EXT_FLAGS = 
 endif
